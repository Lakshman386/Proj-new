...
import {
  ...
  ChevronRight, Layers, Layout, Globe, Package, Cpu, Code, Server, Terminal, Cloud,
  Settings2, MonitorCheck, Network
} from "lucide-react";
...
const TECH_ICONS = {
  ...
  Linux: Server,
  Bash: Terminal,
  Prometheus: MonitorCheck,
  Grafana: MonitorCheck,
  Nginx: Server,
  SonarQube: MonitorCheck,
  Nexus: Package,
  Maven: Package,
  Tomcat: Server,
  default: Package,
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/Lakshman386',
      };
