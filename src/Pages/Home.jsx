    ...
    <div className="relative group">
      ...
      <div className="relative px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
        <span className="bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-transparent bg-clip-text text-xs sm:text-sm font-medium flex items-center">
          <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-blue-400 animate-pulse" />
          Automate Everything
        </span>
      </div>
    </div>
...
const TECH_STACK = ["AWS", "GIT", "Jenkins", "Docker", "Kubernetes"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Lakshman386" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/lakshminarayana-senagavarapu/" },
  { icon: Instagram, link: "https://www.instagram.com/lakshminarayanasenagavarapu/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Reliable, Automated, and Scalable Cloud Infrastructure with DevOps Best Practices.
                </p>
